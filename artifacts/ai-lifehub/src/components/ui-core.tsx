...
export const DemoPill = () => <span className="inline-flex items-center gap-1.5 rounded-full bg-accent/15 px-2.5 py-1 font-mono text-[10px] font-bold uppercase tracking-widest text-accent-foreground"><Sparkles size={12} /> Demo mode</span>;
